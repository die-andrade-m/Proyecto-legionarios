...
<head>
    ...
    <style>
        ...
        /* Override input fields to match dark style */
        input[type="email"],
        input[type="password"],
        input[type="text"] {
    ...
    <div class="container p-3 d-flex justify-content-center">
        <div class="auth-card p-4 p-md-5">
            ...
            <div class="text-center mb-4">
                <a href="/" class="text-decoration-none text-white d-inline-flex flex-column align-items-center gap-2">
                    <img src="{{ asset('images/logo-legionarios.jpg') }}" alt="GYM Legionarios" class="rounded-circle border border-warning shadow" style="width: 70px; height: 70px; object-fit: cover;">
                    <span class="fs-4 fw-bold font-heading text-white tracking-tight">GYM LEGIONARIOS</span>
                    <small class="text-warning text-uppercase fw-semibold" style="font-size: 11px; letter-spacing: 2px;">Un Dojo, Un Espíritu</small>
                </a>
            </div>
